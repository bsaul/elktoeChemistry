...
The population of the critically endangered Appalachian Elktoe mussel (*Alasmidonta raveneliana*) has precipitous declined in North Carolina's Little Tennessee River in recent years. Causes for the decline are unknown and may be multi-faceted. In order to assess possible reasons for the decline, the Aquatic Epidemiology and Conservation Lab at North Carolina State University conducted a experiment in 2013 wherein *A. raveneliana* were collected from the Tuckaseegee River where the population is stable. The *A. raveneliana* plus an equal number of non-endangered *Lampsilis fasciola* were randomly assigned to six sites (three each in the Tuckaseegee and Little Tennessee) and followed for approximately six months.

Unionoids record certain aspects of their environment in the elemental profiles of their valves [CITATIONS]. ...More context here... Chemical measurements obtained by laser ablation inductively coupled plasma mass spectrometry (LA-ICP-MS). @jackson2003laser experimentally fed contaminated fish to banded water snakes and showed LA-ICP-MS on tail tissue and showed LA-ICP-MS was able to differentiate between treatments.

In this paper, we compare chemistries of the study specimen valves to address two sets of questions. First, are any elements associated with the experimental assignments; i.e., river and/or sites? And to what degree? Second, are any elements associated with the observerd morbidity and mortality in *A. raveneliana*?  Our answers represent important contributions to scientific understanding of unionid physiology, ecological experiments, and … . They also lead us to propose hypotheses as to the decline of *A. raveneliana*.

...TODO... brief summary of results ...

The paper is organized as follows. Section \ref{materials-and-methods} outlines the experimental design, data collection and QC processes, and the statistical methods. More details for each of these topics is provided in the supplement. Section \ref{results} provides results. In Section \ref{discussion}, we discuss the implications of our results, hypothesize on causes of the *A. raveneliana*, and suggest future research. We also provide the data and code to reproduce our results at the study website (ADD LINK) 
