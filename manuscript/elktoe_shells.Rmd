...
Figure \ref{} displays p-values for tests that each trace element's trajectory within the nacre differs in at least one experimental site by species. Trajectories of Mn in *A. raveneliana* differ in at least one  site (p = 0.002). Visual examination of the predicted values from a GAMM model show systematically higher levels in the region of most recent growth in Little Tennessee specimens (Figure \ref{}). Results for the comparatively younger L. fasciola specimens show a similar though not as obvious pattern (p = 0.054). 
