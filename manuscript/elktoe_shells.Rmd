...
Analyses were done using R version `r paste(R.Version()$major, R.Version()$minor, sep = ".")` [@rcore2020]. The methodology is further described along with a complete list of R packages in the Supplementary Material.
